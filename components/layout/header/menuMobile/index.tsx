...
export function MenuMobile({ menu, setStateMenu }: MenuMobileProps) {
    ...
    <S.Menu className={`menuMobile ${menu ? 'active' : ''}`}>
      ...
      <div className="menu-mobile">
        <div className="close " onClick={() => setStateMenu(false)}>
          <h3 className="paragraph-2-objective-medium-objective">
            Mapa do site
          </h3>
        ...
        <nav className="link-1-regular">
          {linksMenu.map((categoria, index) => {
            return categoria.categorias ? (
              ...
              <Link
                ...
                href={categoria.href}
                className={`link link-4-objective-medium ${
          ...
          <h3 className="paragraph-2-objective-medium">Contato</h3>

          <div className="actions-redes">
            <a
              href="https://www.instagram.com/autosombra/"
              target={'_blank'}
            ...
            <a
              href="https://www.facebook.com/autosombra"
              target={'_blank'}
              className="link-redes"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
